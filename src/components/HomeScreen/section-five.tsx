  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-green-50">
      <div className="container mx-auto text-center px-4">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-green-700 mb-4">Review</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 px-4 md:px-8 lg:px-16 xl:px-24">
        <div className="order-2 lg:order-1">
          <div className="text-green-600 mb-6 lg:mb-8">
            <h1 className="font-light text-2xl md:text-3xl lg:text-4xl px-2 md:px-4 lg:px-6">Golf Review</h1>
            <p className="mt-2 px-2 md:px-4 lg:px-6 text-sm md:text-base">Samdech Pok</p>
          </div>
